...
<?php
    ...
    <h3>Select lock or acc to start and follow the right text example to add information</h3>
         ...
         <tr class="lock-section">
           ...
           <td>
              ...
              <input type="checkbox" name="lock_cat[]" value="6"> specialty lock <br/>
              <input type="checkbox" name="lock_cat[]" value="7"> key lock <br/>
              <input type="checkbox" name="lock_cat[]" value="8"> alarm lock <br/>
              <input type="checkbox" name="lock_cat[]" value="9"> folding lock <br/>
              <input type="checkbox" name="lock_cat[]" value="10"> accessories <br/>
           </td>
         </tr>
